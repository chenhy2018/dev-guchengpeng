// Last Update:2018-06-14 15:36:45
/**
 * @file answercall_test.c
 * @brief 
 * @author liyq
 * @version 0.1.00
 * @date 2018-06-14
...
int AnswerCallTestSuitInit( TestSuit *this, TestSuitManager *_pManager );
int AnswerCallTestSuitCallback( TestSuit *this );
int AnswerCallTestSuitGetTestCase( TestSuit *this, TestCase **testCase );

AnswerCallTestCase gAnswerCallTestCases[] =
{
    {
        { "normal answer", CALL_STATUS_ESTABLISHED },
        { "1234567890abc" }
    },
    {
...
TestSuit gAnswerCallTestSuit = 
{
    "AnswerCall()",
    AnswerCallTestSuitCallback,
    AnswerCallTestSuitInit,
    AnswerCallTestSuitGetTestCase,
    (void*)&gAnswerCallTestCases,
    0,
};
...
int AnswerCallTestSuitInit( TestSuit *this, TestSuitManager *_pManager )
{
    ...
    this->total = ARRSZ(gAnswerCallTestCases);
    this->index = 0;
...
int AnswerCallTestSuitCallback( TestSuit *this )
{
    AnswerCallTestCase *pTestCases = NULL;
    AnswerCallData *pData = NULL;
    AnswerCallTestCase *pTestCase = NULL;
    int i = 0;
    int ret = 0, callId = 0;
    ...
    pTestCases = (AnswerCallTestCase *) this->testCases;
    UT_LOG("this->index = %d\n", this->index );
            ...
            if ( pEvent ) {
                ...
                if ( CALL_STATUS_INCOMING == pCallEvent->status ) {
                    ...
                    if ( pData->invalidCallId ) {
                        ...
                        ret = AnswerCall( 0, pCallEvent->callID );
                        return ( ret == pTestCase->father.expact ? TEST_PASS : TEST_FAIL );
                    } else {
