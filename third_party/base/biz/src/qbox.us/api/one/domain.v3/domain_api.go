...
func (p Client) Domains(l rpc.Logger, owner uint32, tbl string) (domains []domain.Entry, err error) {

	err = p.Conn.CallWithForm(l, &domains, "/v3/domains", map[string][]string{
