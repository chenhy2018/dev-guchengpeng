...
func NewWithClient(client lb.IClient, cfg *Config) *Client {
	return &Client{Config: cfg, lbClient: client}
}
...
func New(cfg *Config) *Client {
	...
	lbClient := lb.New(&lbCfg, digest_auth.NewTransport(cfg.AccessKey, cfg.SecretKey, transport))
