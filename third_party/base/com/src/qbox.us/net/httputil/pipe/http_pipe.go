package pipe // 本package已经迁移到 "github.com/qiniu/http/httputil/pipe"
...
使用方式：
	...
	import "qbox.us/net/httputil/pipe"
	...
	...
*/
func New() (rr *Reader, rw *Writer) { // 本package已经迁移到 "github.com/qiniu/http/httputil/pipe"
