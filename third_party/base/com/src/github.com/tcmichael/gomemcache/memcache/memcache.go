...
const (
	...
	maxIdleConnsPerAddr = 8 // TODO(bradfitz): make this configurable? tcmichael: rewrite the value
)
...
func (c *Client) dial(addr net.Addr) (nc net.Conn, err error) {
