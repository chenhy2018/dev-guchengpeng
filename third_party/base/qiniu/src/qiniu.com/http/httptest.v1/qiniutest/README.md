...
* [httptest.v1/README.md](https://github.com/qbox/base/tree/develop/qiniu/src/github.com/qiniu/http/httptest.v1)
...
authstub 可用于 mock 测试环境，这样测试就不依赖真实的账号认证服务。比如和 [qboxmockgate](https://github.com/qbox/base/tree/develop/qiniu/src/qiniu.com/apigate.v1/qiniumockgate) 搭配。

但 authstub 更为常见的用法是用于单元测试环境（因为单元测试环境完全没有必要接真实的账号服务）。例如：

* [qiniu.com/examples/apigate.v1/apigate_example_test.go](https://github.com/qbox/base/blob/develop/qiniu/src/qiniu.com/examples/apigate.v1/apigate_example_test.go)
