...
func init() {
	...
	apigate.RegisterAccessInfo("user", USER_TYPE_USERS)
	apigate.RegisterAccessInfo("expuser", USER_TYPE_EXPUSER)
	apigate.RegisterAccessInfo("admin", USER_TYPE_ADMIN)
	apigate.RegisterAccessInfo("qcos", USER_TYPE_QCOS)
}
