...
typedef int (*VIDEO_CALLBACK)(char *frame, int len, int iskey, double timestatmp, unsigned long frame_index,	unsigned long keyframe_index, void *pcontext);
...
int dev_sdk_get_VideoOSDConfig(VideoOverlay *pConfig);
...
int dev_sdk_get_LogConfig(SyslogConfig *pLogCfg);
...
int dev_sdk_set_ModuleConfig(int moduleid,char *xmlconfig);
int dev_sdk_set_MotionDetectAlarm(MotionDetectAlarm *pMDAlm);  
int dev_sdk_set_VideoCoverAlarm(VideoCoverAlarm *pVideoCover); 
int dev_sdk_set_AudioAlarmAlarm(AudioAlarm *pConfig);
int dev_sdk_set_VideoGateAlarmAlarm(VideoGateAlarm *pConfig);
int dev_sdk_set_PdAlarmAlarm(PdAlarm *pConfig) ;


int dev_sdk_set_MiscConfig(MiscConfig *pCfg);  
int dev_sdk_set_RecordConfig(RecordConfig *pCfg);
int dev_sdk_set_VideoCaptureConfig(VideoCapture *pCaptureCfg); 
int dev_sdk_set_VideoEncodeConfig(VideoEncode *pEncodeCfg);
...
int dev_sdk_set_VideoConfig(VideoConfig *pVideoCfg);   
int dev_sdk_set_AudioConfig(AudioConfig *pAudioCfg);   
int dev_sdk_set_AudioEncode(AudioEncode *pAudioCfg) ;
int dev_sdk_set_AudioCapture(AudioCapture *pAudioCfg);   
